class Easy extends Phaser.Scene{
    constructor(){ //Function that constructs the class "Easy" using the constructor function from Phaser.Scene.
        super({key: "Easy"})
    }
    ...
    update(){
        ...
        this.physics.moveTo(this.bird, this.money.x, this.money.y, 100); //Sets how the bird follows the coin.
