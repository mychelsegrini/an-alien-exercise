class Hardcore extends Phaser.Scene{
    constructor(){ //Function that constructs the class "Hardcore" using the constructor function from Phaser.Scene.
        super({key: "Hardcore"})
    }
    ...
    update(){
        ...
        this.physics.moveTo(this.bird, this.money.x, this.money.y, 200); //Sets how the bird follows the coin.
